...
// SWRのためのfetcher関数
const fetcher = (url: string): Promise<VideoWithAuthor[]> =>
...
export default function VideoFeed() {
  const {
    ...
    error,
    isLoading,
  } = useSWR<VideoWithAuthor[]>("/api/feed", fetcher);
  ...
  return (
    <div
      {...handlers}
      className="relative w-full h-[80vh] max-w-md mx-auto bg-black rounded-lg overflow-hidden"
    >
